...
// import { FaWhatsapp, FaEnvelope, FaPhone, FaFacebookF, FaTwitter, FaLinkedinIn } from 'react-icons/fa';
...
//       {/* <button
//         onClick={scrollToTop}
//         className="bg-gray-500 text-white p-3 rounded-full shadow-lg hover:bg-gray-600 transition-colors duration-300 mt-2"
