...
const Footer = () => {
  return (
    <footer className="bg-gray-100 dark:bg-[#1E2235] text-gray-900 dark:text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold">Gitau Justus</h3>
            <p className="text-sm">Software Engineer & ICT Professional</p>
          </div>
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/@justoegitau1"><BsFacebook size={26} className="text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-200" /></a>
            ...
            <a href="https://github.com/gitaujustus"><BsGithub size={26} className="text-gray-900 dark:text-white hover:text-gray-100 dark:hover:text-gray-300" /></a>
